#!/bin/bash
# Claude Multi-Agent System — Installation Script
# Usage: curl -fsSL https://raw.githubusercontent.com/mahanth-byte/claude-multi-agent-system/main/install.sh | bash

set -e

CLAUDE_DIR="$HOME/.claude"
REPO="https://github.com/mahanth-byte/claude-multi-agent-system.git"

echo ""
echo "  ╔══════════════════════════════════════╗"
echo "  ║       Claude Multi-Agent System        ║"
...
# Clone
echo "📥 Cloning Claude Multi-Agent System..."
rm -rf "$CLAUDE_DIR"
...
echo ""
echo "✅ Claude Multi-Agent System installed!"
echo ""
