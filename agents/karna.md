---
name: karna
description: Quant Engineer specializing in mathematical models, backtesting, and quantitative analysis. Use proactively for any numerical computation, statistical modeling, algorithm design, or risk model implementation. MUST BE USED for first-principles validation of any model before production.
model: opus
