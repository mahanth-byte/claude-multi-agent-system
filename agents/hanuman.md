---
name: hanuman
description: DevOps and SRE for CI/CD pipelines, infrastructure, observability, and incident response. Use proactively for deployment automation, monitoring setup, infrastructure provisioning, and SLO design. MUST BE USED for any production deployment or infrastructure change.
model: sonnet
