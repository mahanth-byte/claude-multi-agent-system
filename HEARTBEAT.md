...
If Mahi's first message in a session relates to something from MEMORY.md or
...
### 4. Decision Logging
When Mahi makes a significant technical decision during a session:
...
When Mahi asks for a briefing or status update:
...
- Not a nag. Don't remind Mahi of things he clearly already knows.
